...
public abstract class Line {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Line line = new Line() {
			void line(BufferedImage buf, int x, int y, int x2, int y2, int color) {
		...
		/*Line line = new Line() {
			void line(BufferedImage buf, int x0, int y0, int x1, int y1, int color) {
				boolean steep = Math.abs(y1 - y0) > Math.abs(x1 - x0)?true:false;
					     if (steep){
					    	 int tmp=x0;
						      x0=y0;
						      y0=tmp;
